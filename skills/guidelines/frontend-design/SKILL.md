...
description: Guidelines for creating distinctive, production-grade frontend interfaces that avoid generic AI aesthetics. Follow when building web components, pages, dashboards, or any web UI.
type: guideline
---
